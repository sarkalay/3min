...
if LEARN_SCRIPT_AVAILABLE:
    class FullyAutonomous1HourAITrader(SelfLearningAITrader):
        ...
        def _initialize_trading(self):
            ...
            self.max_position_size_percent = 25
    ...
    class FullyAutonomous1HourAITrader(object):
        ...
        def get_market_news_sentiment(self):
            try:
                news_sources = ["CoinDesk", "Cointelegraph", "CryptoSlate", "Decrypt", "Binance Blog"]
            ...
            try:
                ...
                if close_success:
                    ...
                    if pair in self.ai_opened_trades:
                        self.print_color(f"Position still exists after close, forcing removal...", self.Fore.RED)
                    ...
                    if new_ai_decision["decision"] in ["LONG", "SHORT"] and new_ai_decision["position_size_usd"] > 0:
                        ...
                        correct_reverse_direction = "SHORT" if current_direction == "LONG" else "LONG"
        ...
        def get_current_price(self, pair):
            try:
                if self.binance:
                    ...
                    mock_prices = {"BTCUSDT": 45000, "BNBUSDT": 300, "SOLUSDT": 180, "AVAXUSDT": 35}
        ...
        try:
            ...
            if close_success:
                ...
                if pair in self.paper_positions:
                    self.real_bot.print_color(f"PAPER: Position still exists after close, forcing removal...", self.Fore.RED)
